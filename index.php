	...
	<?php
		if (isset($_POST["task"])) {
		    ...
		    if (mysqli_query($conn, $sql)) {
			  echo '<div id="toast" style="position: absolute; top: 15%; left: 78%; background-color: #39B81C; width: 20%; border-radius: 8px">
		...
		if (isset($_POST["taskupdate"])) {
		    ...
		    $sql = "UPDATE `list` SET `task` = '$taskupdate' WHERE `id` = '$id'";

		    if (mysqli_query($conn, $sql)) {
			  echo '<div id="toast" style="position: absolute; top: 15%; left: 78%; background-color: #39B81C; width: 20%; border-radius: 8px">
			  		<p style="text-align: center; padding: 25px 30px; color: #fff; font-size: 18px">data updated successfully.</p>
			  		</div>';
			} else {
			  echo "Error: " . $sql . "<br>" . mysqli_error($conn);
			}
	...
	<html>
		...
		<body>
			<main>
				<div class="buttons">
					<button class="b1"  onclick="task()">Tasks</button>
				</div>
				<div class="buttons">
					<button class="b1"  onclick="completed()">Completed</button>
				</div>

				<div class="clear"></div>

				<div class="container" id="data">
					<h1 class="app-title">Today's List</h1>
					...
					<form method="POST" action="index.php">
						<input autofocus name="task" type="text" aria-label="Enter a new todo item" placeholder="add items...">
						<button name="add" class="add-button">Add</button>
					</form>

					<div class="list">
						<ul>
							<?php
								$sql = "SELECT * FROM list WHERE completed = 0";
								...
								?>
								  	...
								  	<li><?php 
								  		...
								  		/* <a href='Update.php?id=<?php echo $row["id"]?>' class='mr-2 btn-icon btn-icon-only btn btn-outline-info edittask'><button class='item_button'>Update</button></a> */
								  		
								  		
								            echo "<a href='Update.php?id=".$row["id"]."'><button class='item_button'>Update</button></a>";
								        
								            echo "<a href='delete.php?id=" . $row["id"] . "'><button class='item_button'>Delete</button></a>";

								            echo "<a href='completed.php?id=" . $row["id"] . "'><button class='item_button'>Completed</button></a>";
								            ?>
								  ...
								  echo '<div style="margin-left: 30px; font-size:20px;"><p>No Data Found</p></div>';
								}
							?>
				...
				<div>
					<table id="t01">
						...
						<tr>
					  	...
					  	<?php
							$sql = "SELECT * FROM list WHERE completed = 1";
			...
			<script type="text/javascript">
				function completed() {
  					...
  					document.getElementById("t01").style.display="inline-table";
				}
